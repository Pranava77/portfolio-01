    ...
    <>
      ...
      {showContent && (
        <div className="main w-full overflow-x-hidden select-none">
          ...
          <footer className="footer bg-black text-zinc-100 p-2 font-[PlayReg]">
      <div className="footer-container">
    
   
        <div className="flex flex-col justify-center">
          <p className="text-center md:text-center text-sm md:text-md">
            © {new Date().getFullYear()} Pranava Holla. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
